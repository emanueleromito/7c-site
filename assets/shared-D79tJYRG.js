(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))n(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const o of t.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function l(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function n(e){if(e.ep)return;e.ep=!0;const t=l(e);fetch(e.href,t)}})();const f="/assets/logo-new-Dx7AcjjY.png";(function(){class i extends HTMLElement{connectedCallback(){let t=!1;try{t=!!localStorage.getItem("7c_user")}catch{}const o=t?'<a href="/archive.html">ACCOUNT</a>':'<a href="/claim.html">CHECK-IN</a>';this.innerHTML=`
      ...
      `}}customElements.define("site-header",i);class l extends HTMLElement{connectedCallback(){const t=this.getAttribute("theme")||"light",o=t==="dark"?"#0a0a0a":"#ffffff",a=t==="dark"?"#f2f0ec":"#0a0a0a",r=t==="dark"?"rgba(255,255,255,.5)":"#888",s=t==="dark"?"rgba(255,255,255,.15)":"rgba(0,0,0,.1)";this.innerHTML=`
        <style>
          .site-footer {
            background: ${o}; color: ${a}; padding: 40px 48px;
          ...
          .foot-cols b {
            ...
            color: ${r}; margin-bottom: 24px; font-weight: 500;
          }
          .foot-cols a {
            display: block; padding: 6px 0; font-size: 13px; color: ${a}; transition: opacity .2s;
          }
          ...
          .foot-bottom {
            ...
            font-size: 10px; letter-spacing: .16em; text-transform: uppercase; color: ${r};
          }
          ...
          .foot-launch:hover { opacity: 1; color: ${a}; }
